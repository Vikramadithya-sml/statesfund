...
async function createFolder(folderID, folderName){
  ...
  var doesntExists = true;
  var newFolder = '';
  // var temp_folder = DriveApp.getFilesByName(folderName)
  var num = 0
  // Check if folder already exists.
  ...
  while(subFolders.hasNext()){
    ...
    if(folder.getName() == folderName){
      doesntExists = false;
      newFolder = folder;
      // console.log(temp_folder.toString(),temp_folder.hasNext(),temp_folder.next(),temp_folder.getContinuationToken(),"the other times ")
      console.log(num)
  ...
  if(doesntExists == true){
    //If the file doesn't exists
    // console.log(temp_folder.toString(),temp_folder.hasNext(),temp_folder.next(),temp_folder.getContinuationToken(),"first time ")
...
// A-f73d84af	DVelazquez@scif.com	Witten Logging CO	9082184-2021	Pam Witten	pwitten@aol.com		2022-01-14 10:23 AM PST	Upload Failure - Search Drive or Re-Request	https://drive.google.com/drive/folders/1X9xkmVxwoWyguzSKDzOEvexmanNtwR0d				6/13/2022	
